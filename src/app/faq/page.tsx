...
const faqs = [
  {
    ...
    answer: "Pesanku adalah sebuah platform marketplace khusus sistem Pre-Order. Kami menjembatani pembeli dengan berbagai penjual UMKM yang membuat produk kustom, makanan sistem PO (Pesan Antar), maupun barang-barang koleksi secara aman dan terpercaya."
  },
  {
      ...
      <main className="flex-1 container mx-auto px-4 py-12 max-w-4xl">
        <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12 border border-gray-100">
            ...
            {faqs.map((faq, index) => (
              <div key={index} className="bg-white border text-left p-6 rounded-xl hover:shadow-md transition-shadow">
                <h3 className="text-lg font-bold text-slate-800 mb-3 flex items-start">
                  <span className="text-green-500 mr-3 text-xl font-black">Q.</span>
                  {faq.question}
                </h3>
          ...
          <div className="mt-12 bg-green-50 p-6 rounded-xl text-center">
            ...
            <a href="mailto:support@pesanku.id" className="inline-block px-8 py-3 bg-green-600 text-white font-semibold rounded-xl hover:bg-green-700 transition-colors shadow-sm cursor-pointer">
              Hubungi Support
            </a>
          </div>
